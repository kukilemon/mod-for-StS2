...
namespace IreneMod.Models.Characters;

public sealed class Irene : CharacterModel
{
    ...
    public override CardPoolModel CardPool => ModelDb.CardPool<IreneCardPool>();

    public override RelicPoolModel RelicPool => ModelDb.RelicPool<IreneRelicPool>();
