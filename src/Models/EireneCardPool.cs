...
public sealed class EireneCardPool : CardPoolModel
{
    // Pure-code milestone: reuse Ironclad presentation resources until Eirene art is added.
    ...
    [
        ...
        ,ModelDb.Card<EireneMetamorphosis>()
